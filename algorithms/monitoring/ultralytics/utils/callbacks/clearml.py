...
def on_pretrain_routine_start(trainer):
    ...
    try:
        if task := Task.current_task():
            ...
            # We are logging these plots and models files manually in the integration
...
def on_fit_epoch_end(trainer):
    """Reports models information to logger at the end of an epoch."""
    if task := Task.current_task():
...
def on_train_end(trainer):
    """Logs final models and its name on training completion."""
    if task := Task.current_task():
