...
This module enables MLflow logging for Ultralytics YOLO. It logs metrics, parameters, and models artifacts.
...
def on_train_end(trainer):
    """Log models artifacts at the end of the training."""
    if not mlflow:
        return
