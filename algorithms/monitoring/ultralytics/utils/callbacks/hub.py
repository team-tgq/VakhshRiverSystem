...
def on_pretrain_routine_start(trainer):
    """Create a remote Ultralytics HUB session to log local models training."""
...
def on_train_end(trainer):
    """Upload final models and metrics to Ultralytics HUB at the end of training."""
    if session := getattr(trainer, "hub_session", None):
        # Upload final models and metrics with exponential standoff
        LOGGER.info(f"{PREFIX}Syncing final models...")
        ...
        LOGGER.info(f"{PREFIX}Done ✅\n{PREFIX}View models at {session.model_url} 🚀")
