...
class ConfusionMatrix:
    ...
    def __init__(self, nc, conf=0.25, iou_thres=0.45, task="detect"):
        """Initialize attributes for the YOLO models."""
        self.task = task
...
class Metric(SimpleClass):
    """
    Class for computing evaluation metrics for YOLOv8 models.
    ...
    def __init__(self) -> None:
        """Initializes a Metric instance for computing evaluation metrics for the YOLOv8 models."""
        self.p = []  # (nc, )
        self.r = []  # (nc, )
        self.f1 = []  # (nc, )
        self.all_ap = []  # (nc, 10)
    ...
    def update(self, results):
        """
        Updates the evaluation metrics of the models with a new set of results.
...
class DetMetrics(SimpleClass):
    ...
    def class_result(self, i):
        """Return the result of evaluating the performance of an object detection models on a specific class."""
...
class SegmentMetrics(SimpleClass):
    ...
    @property
    def results_dict(self):
        """Returns results of object detection models for evaluation."""
        return dict(zip(self.keys + ["fitness"], self.mean_results() + [self.fitness]))
...
class ClassifyMetrics(SimpleClass):
    ...
    Attributes:
        ...
        fitness (float): The fitness of the models, which is equal to top-5 accuracy.
    ...
    @property
    def results_dict(self):
        """Returns a dictionary with models's performance metrics and fitness score."""
