...
def update_models(model_names=("yolo11n.pt",), source_dir=Path("."), update_names=False):
    ...
    Args:
        ...
        update_names (bool): Update models names from a data YAML.
    ...
    for model_name in model_names:
        ...
        model.half()
        if update_names:  # update models names from a dataset YAML
            model.model.names = default_class_names("coco8.yaml")

        # Define new save path
        save_path = target_dir / model_name

        # Save models using models.save()
        print(f"Re-saving {model_name} models to {save_path}")
