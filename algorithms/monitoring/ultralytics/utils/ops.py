...
class Profile(contextlib.ContextDecorator):
    ...
    def __init__(self, t=0.0, device: torch.device = None):
        ...
        Args:
            ...
            device (torch.device): Devices used for models inference. Defaults to None (cpu).
        """
        self.t = t
        self.device = device
...
def non_max_suppression(
    ...
    Args:
        ...
        end2end (bool): If the models doesn't require NMS.
    ...
    if prediction.shape[-1] == 6 or end2end:  # end-to-end models (BNC, i.e. 1,300,6)
...
def masks2segments(masks, strategy="all"):
    ...
    Args:
        masks (torch.Tensor): the output of the models, which is a tensor of shape (batch_size, 160, 160)
