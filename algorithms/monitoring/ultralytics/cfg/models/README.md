...
```bash
# Train a YOLO11n models using the coco8 dataset for 100 epochs
yolo task=detect mode=train models=yolo11n.yaml data=coco8.yaml epochs=100
```
...
# Initialize a YOLO11n models from a YAML configuration file
model = YOLO("models.yaml")

# If a pre-trained models is available, use it instead
# models = YOLO("models.pt")

# Display models information
model.info()

# Train the models using the COCO8 dataset for 100 epochs
