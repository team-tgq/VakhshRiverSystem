...
class Results(SimpleClass):
    ...
    Examples:
        >>> results = models("path/to/image.jpg")
    ...
    def __init__(
        ...
        Notes:
            For the default pose models, keypoint indices for human body pose estimation are:
    ...
    def __getitem__(self, idx):
        ...
        Examples:
            >>> results = models("path/to/image.jpg")  # Perform inference
    ...
    def show(self, *args, **kwargs):
        ...
        visualize the models's predictions directly.
...
class Boxes(BaseTensor):
    ...
    def id(self):
        ...
        Examples:
            >>> results = models.track("path/to/video.mp4")
            >>> for result in results:
            ...     boxes = result.boxes
            ...     if boxes.is_track:
            ...         track_ids = boxes.id
...
class Probs(BaseTensor):
    ...
    def top1conf(self):
        ...
        Examples:
            >>> results = models("image.jpg")  # classify an image
    ...
    def top5conf(self):
        ...
        predicted by the models. It provides a quick way to access the most likely class predictions
...
class OBB(BaseTensor):
    ...
    def conf(self):
        ...
        represents the models's certainty in the detection.
    ...
    def id(self):
        ...
        Examples:
            >>> results = models("image.jpg", tracker=True)  # Run inference with tracking
            >>> for result in results:
