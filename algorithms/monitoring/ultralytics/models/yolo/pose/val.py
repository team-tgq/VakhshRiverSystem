...
class PoseValidator(DetectionValidator):
    """
    A class extending the DetectionValidator class for validation based on a pose models.

    Example:
        ```python
        from ultralytics.models.yolo.pose import PoseValidator

        args = dict(models="yolo11n-pose.pt", data="coco8-pose.yaml")
    ...
    def init_metrics(self, model):
        """Initiate pose estimation metrics for YOLO models."""
    ...
    def plot_predictions(self, batch, preds, ni):
        """Plots predictions for YOLO models."""
    ...
    def eval_json(self, stats):
        """Evaluates object detection models using COCO JSON format."""
