...
class OBBPredictor(DetectionPredictor):
    """
    A class extending the DetectionPredictor class for prediction based on an Oriented Bounding Box (OBB) models.
    ...
    Example:
        ...
        args = dict(models="yolo11n-obb.pt", source=ASSETS)
    ...
    def __init__(self, cfg=DEFAULT_CFG, overrides=None, _callbacks=None):
        """Initializes OBBPredictor with optional models and data configuration overrides."""
