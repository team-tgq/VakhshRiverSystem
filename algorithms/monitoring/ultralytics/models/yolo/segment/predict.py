...
class SegmentationPredictor(DetectionPredictor):
    """
    A class extending the DetectionPredictor class for prediction based on a segmentation models.
    ...
    Example:
        ...
        args = dict(models="yolo11n-seg.pt", source=ASSETS)
    ...
    def postprocess(self, preds, img, orig_imgs):
        ...
        # tuple if PyTorch models or array if exported
