...
class SAMModel(nn.Module):
    ...
    def set_imgsz(self, imgsz):
        ...
        self.prompt_encoder.image_embedding_size = [x // 16 for x in imgsz]  # 16 is fixed as patch size of ViT models
...
class SAM2Model(torch.nn.Module):
    ...
    Examples:
        >>> models = SAM2Model(image_encoder, memory_attention, memory_encoder)
        >>> image_batch = torch.rand(1, 3, 512, 512)
        >>> features = models.forward_image(image_batch)
        >>> track_results = models.track_step(0, True, features, None, None, None, {})
    """
    ...
    @property
    def device(self):
        """Returns the device on which the models's parameters are stored."""
    ...
    def _forward_sam_heads(
        ...
        Examples:
            ...
            >>> results = models._forward_sam_heads(backbone_features, point_inputs, mask_inputs)
            >>> (
            ...     low_res_multimasks,
            ...     high_res_multimasks,
            ...     ious,
    ...
    def forward_image(self, img_batch: torch.Tensor):
        """Processes image batch through encoder to extract multi-level features for SAM models."""
