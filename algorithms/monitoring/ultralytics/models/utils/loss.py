...
class DETRLoss(nn.Module):
    ...
    DETR object detection models. It computes classification loss, bounding box loss, GIoU loss, and optionally auxiliary
    losses.
...
class RTDETRDetectionLoss(DETRLoss):
    ...
    This class computes the detection loss for the RT-DETR models, which includes the standard detection loss as well as
