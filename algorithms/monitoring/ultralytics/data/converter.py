...
def yolo_bbox2segment(im_dir, save_dir=None, sam_model="sam_b.pt", device=None):
    ...
    Args:
        ...
        sam_model (str): Segmentation models to use for intermediate segmentation data; optional.
    ...
    LOGGER.info("Detection labels detected, generating segment labels by SAM models!")
