...
# Load an official or custom models
model = YOLO("yolo11n.pt")  # Load an official Detect models
model = YOLO("yolo11n-seg.pt")  # Load an official Segment models
model = YOLO("yolo11n-pose.pt")  # Load an official Pose models
model = YOLO("path/to/best.pt")  # Load a custom trained models

# Perform tracking with the models
...
yolo track models=yolo11n.pt source="https://youtu.be/LNwODJXcvt4"  # Official Detect models
yolo track models=yolo11n-seg.pt source="https://youtu.be/LNwODJXcvt4"  # Official Segment models
yolo track models=yolo11n-pose.pt source="https://youtu.be/LNwODJXcvt4"  # Official Pose models
yolo track models=path/to/best.pt source="https://youtu.be/LNwODJXcvt4"  # Custom trained models

# Track using ByteTrack tracker
yolo track models=path/to/best.pt tracker="bytetrack.yaml"
```
...
yolo track models=yolo11n.pt source="https://youtu.be/LNwODJXcvt4" conf=0.3, iou=0.5 show
```
...
# Load the models and run the tracker with a custom configuration file
model = YOLO("yolo11n.pt")
...
```bash
# Load the models and run the tracker with a custom configuration file using the command line interface
yolo track models=yolo11n.pt source="https://youtu.be/LNwODJXcvt4" tracker='custom_tracker.yaml'
```
...
def run_tracker_in_thread(filename, model):
    """Starts multi-thread tracking on video from `filename` using `models` and displays results frame by frame."""
