...
class BOTSORT(BYTETracker):
    ...
    Methods:
        ...
        multi_predict(tracks): Predict and track multiple objects with YOLOv8 models.
    ...
    Note:
        The class is designed to work with the YOLOv8 object detection models and supports ReID only if enabled via args.
    """
