...
class KalmanFilterXYAH:
    ...
    respective velocities. Object motion follows a constant velocity models, and bounding box location (x, y, a, h) is
    taken as a direct observation of the state space (linear observation models).
    ...
    def __init__(self):
        """
        Initialize Kalman filter models matrices with motion and observation uncertainty weights.

        The Kalman filter is initialized with an 8-dimensional state space (x, y, a, h, vx, vy, va, vh), where (x, y)
        represents the bounding box center position, 'a' is the aspect ratio, 'h' is the height, and their respective
        velocities are (vx, vy, va, vh). The filter uses a constant velocity models for object motion and a linear
        observation models for bounding box location.
        ...
        # the amount of uncertainty in the models.
...
class KalmanFilterXYWH(KalmanFilterXYAH):
    ...
    The object motion follows a constant velocity models, and the bounding box location (x, y, w, h) is taken as a direct
    observation of the state space (linear observation models).
