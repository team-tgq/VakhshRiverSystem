...
class AIGym(BaseSolution):
    ...
    Examples:
        >>> gym = AIGym(models="yolo11n-pose.pt")
    ...
    def __init__(self, **kwargs):
        ...
        # Check if the models name ends with '-pose'
        if "models" in kwargs and "-pose" not in kwargs["models"]:
            kwargs["models"] = "yolo11n-pose.pt"
        elif "models" not in kwargs:
            kwargs["models"] = "yolo11n-pose.pt"
    ...
    def monitor(self, im0):
        ...
        the YOLO Pose models to detect keypoints, estimate angles, and count repetitions based on predefined
        angle thresholds.
